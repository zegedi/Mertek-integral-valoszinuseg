...
\begin{document}
	...
	\end{theorem}
	\begin{proof}
		\Aref{eq:majdnem-mindenhol-01} állítás bizonyítása.
	...
	\begin{proof}
		...
		\Aref{eq:fatou-02} állítás bizonyítását nem részletezzük.
		...
		\]
		Ezek után alkalmazva \aref{eq:fatou-01} állítást az
		\[
